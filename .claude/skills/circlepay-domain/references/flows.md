...
In-app: progress, contributors (incl. Anonymous), Contribute + Share (WhatsApp/SMS/Copy), USSD note. Public: hero, "The story", contributors, trust footer ("funds go straight to the verified hospital… Powered by Moolre"). **Money steps:** contribute = Collection; payout to hospital = Transfer (wallet or bank).
